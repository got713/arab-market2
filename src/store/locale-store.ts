...
export const translations: TranslationDictionary = {
  ...
  'nav.bestsellers': { en: 'Best Sellers', ar: 'الأكثر مبيعاً' },
  ...
  'header.search': { en: 'Search groceries...', ar: 'ابحث عن منتجات البقالة...' },
  ...
  // Hero Section
  'hero.title': { en: 'Middle Eastern Groceries. Delivered Across America.', ar: 'بقالة شرق أوسطية. توصيل لكافة الولايات الأمريكية.' },
  'hero.subtitle': { en: 'Shop your favorite Arabic and Middle Eastern groceries, sweets, beverages, frozen foods, spices, and everyday essentials — delivered to your door.', ar: 'تسوق البقالة والحلويات والمشروبات والمجمدات والبهارات والمستلزمات الشرق أوسطية والعربية المفضلة لديك — وتصلك حتى باب منزلك.' },
